    ...
    return (
        ...
        >
            ...
            <div className="w-full max-w-md p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl relative">
                ...
                {/* subtle glow */}
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-indigo-500/10 via-transparent to-blue-500/10 pointer-events-none"></div>
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                            Sign in to continue to Bootcamp IDE
                        </p>
                    </div>
